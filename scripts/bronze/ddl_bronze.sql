/* ============================================================
   ...
   PURPOSE:
       ...
       - Recreates them with the defined structure
       - Used to initialize or reset the Bronze layer in the Data Warehouse

   NOTES:
       - OBJECT_ID() is used to check whether a table exists
       - 'U' indicates a User-defined table
